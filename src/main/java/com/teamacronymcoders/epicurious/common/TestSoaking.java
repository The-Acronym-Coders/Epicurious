...
public class TestSoaking {
    private static ResourceLocation id = new ResourceLocation(Epicurious.MODID, "leather1");
    ...
    public static void setupTestRecipe() {
        RecipeHelper.addSoakingRecipe(id, fluidStack, ingredient, stack, decrease, chance, ticks);
    }
}
